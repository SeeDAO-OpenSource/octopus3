    ...
    <nav ref="menu" id="sidebar">
      ...
      >
        <li class="menu">
          ...
          <b-collapse id="home" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              ...
              <router-link tag="li" to="/my/badges" @click.native="toggleMobileMenu">
                <a>{{ $t("my-badges") }}</a>
              </router-link>
            </ul>
          </b-collapse>
          ...
          <b-collapse id="services" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                ...
                to="/services/sgn"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("mint-sgn") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/services/invoice"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("send-an-invoice") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/services/weekly/submit"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("weekly-submission") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/services/permissions/transfer"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("permission-transfer") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        ...
        <li class="menu">
          ...
          <b-collapse id="guilds" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/guilds/credits"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("guild-credits") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/guilds/members"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("guild-members") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="projects" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/projects/credits"
              ...
              <router-link
                ...
                to="/projects/members"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("project-members") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="treasury" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/treasury/community"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("community-treasury") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/treasury/cityhall"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("cityhall-treasury") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="cityhall" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/cityhall/register"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("cityhall-registration") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/cityhall/budget"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("budget-overview") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/cityhall/finance"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("financial-report") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="insights" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/insights/credits"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("credits-insights") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/insights/keymetrics"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("keymetrics-insights") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/insights/community"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("community-insights") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/insights/governance"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("governance-insights") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="document" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/documents/sip"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("sip-documents") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/documents/onboarding"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("onboarding-tutorials") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/documents/governance"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("governance-guideline") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/documents/materials"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("seedao-materials") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        ...
        <li class="menu">
          ...
          >
            <div class="">
              ...
              <span>{{ $t("onchain-information") }}</span>
            </div>
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <b-collapse id="contracts" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                ...
                to="/contracts/sgn"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("sgn-contract") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/contracts/credit"
