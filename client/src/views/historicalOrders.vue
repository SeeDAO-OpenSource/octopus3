<template>
  <div class="panel br-6 ">
    <div class="custom-table panel-body p-0">
      ...
      >
        <b-button variant="primary" class="m-1" @click="export_table('csv', orders)"
          >CSV</b-button
        >
        <json-excel
          ...
          >Excel</json-excel
        >
        <b-button variant="primary" class="m-1" @click="export_table('print', orders)"
          >Print</b-button
        >
        <b-button variant="primary" class="m-1" @click="export_table('pdf', orders)"
          >PDF</b-button
        >
      </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: "quotationName", label: "Quotation", sortable: true },
        ...
        { key: "totalCost", label: "Total Cost", sortable: true },
         { key: "orderState", label: "State", sortable: true },
