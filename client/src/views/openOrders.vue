    ...
    <div class="custom-table panel-body p-0">
      ...
      >
        ...
        <template #cell(icon)="row">
          <cryptoicon
            v-if="row.item.quotation.name.replace('USDT','') === 'LUNA'"
            :symbol="'generic'"
            size="16"
          />
          <cryptoicon
            v-else-if="row.item.quotation.name.replace('USDT','') === 'QNT'"
            :symbol="'generic'"
            size="16"
          />
          <cryptoicon
            v-else-if="row.item.quotation.name.replace('USDT','') === 'HNT'"
            :symbol="'generic'"
            size="16"
          />
          <cryptoicon
            v-else-if="row.item.quotation.name.replace('USDT','') === 'AVAX'"
            :symbol="'generic'"
            size="16"
          />
          <cryptoicon
            v-else-if="row.item.quotation.name.replace('USDT','') === 'AXS'"
            :symbol="'generic'"
            size="16"
          />
          <cryptoicon v-else :symbol="row.item.quotation.name.replace('USDT','')" size="16" />
        </template>
      </b-table>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: "executedVolume", label: "Executed Volume", sortable: true },        
