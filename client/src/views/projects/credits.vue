<template>
              ...
              <nav class="breadcrumb-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item">
                    <a href="javascript:;">{{ $t('projects') }}</a>
                  </li>
                  <li class="breadcrumb-item active" aria-current="page">
                    <span>{{ $t('project-credits') }}</span>
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div class="col-12 layout-spacing">
                <div class="panel br-6 ">
                    <div class="custom-table panel-body p-0">
                        <div class="d-flex flex-wrap justify-content-center justify-content-sm-between  px-3 pt-3 pb-0">
                            <b-button variant="primary" class="m-1" @click="export_table('csv')">CSV</b-button>
                            <b-button variant="primary" class="m-1" @click="export_table('print')">ADD</b-button>
                        </div>
  ...
  export default {
    ...
    methods: {
            bind_data() {
                this.columns = [
                    { key: 'to', label: '登記人', sortable: true,thClass: 'text-center w-90' },
                    { key: 'organization', label: '公會'},
                    { key: 'from', label: '發放人', sortable: true },
                    { key: 'integral', label: '積分', sortable: true },
                    { key: 'modifydatetime', label: '時間', sortable: true },
                    { key: 'reason', label: '原因', sortable: false },
                    { key: 'action', label: 'Actions', class: 'actions text-center' }
                ];
                this.items = [
                    { id: 1, to: 'boy-1.png', organization: 'Tiger Nixon', from: 'System Architect', integral: 61, modifydatetime: '2011/04/25', reason: '320,800' },
                    { id: 2, to: 'boy-1.png', organization: 'Garrett Winters', from: 'Accountant',  integral: 63, modifydatetime: '2011/07/25', reason: '170,750' },
                    { id: 3, to: 'boy.png', organization: 'Ashton Cox', from: 'Junior Technical Author', integral: 66, modifydatetime: '2009/01/12', reason: '86,000' },
                    { id: 4, to: 'boy-1.png', organization: 'Cedric Kelly', from: 'Senior Javascript Developer', office: 'Edinburgh', integral: 22, modifydatetime: '2012/03/29', reason: '433,060' },
                    { id: 5, to: 'girl-1.png', organization: 'Airi Satou', from: 'Accountant',  integral: 33, modifydatetime: '2008/11/28', reason: '162,700' },
