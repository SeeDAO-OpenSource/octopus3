module.exports = {
  getHtml: (code) => {
    return (
      ...
      '<tr>' +
      '<td style="width:50px;">' +
      '<img alt="SeeDAO Logo" height="auto" src="https://imgur.com/j3kIgLV.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="50" />' +
      '</td>' +
      '</tr>' +
      '</tbody>' +
      '</table>' +
      ...
      '<h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: bold;"> SeeDAO 验证码</h1>' +
      '</div>' +
      '</td>' +
      '</tr>' +
      '</tbody></table>' +
      ...
      '<tr>' +
      '<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">' +
      '<br/><br/><div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:24px;text-align:left;color:#434245;">SeeDAO 市政厅</div>' +
      '</td>' +
      '</tr>' +
      '<tr>' +
      '<td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">' +
